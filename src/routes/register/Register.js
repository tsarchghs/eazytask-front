...
class Register extends React.Component {
    ...
    onSubmit = async e => {
        ...
        if (this.props.auth[POST_USER] && this.props.auth[POST_USER].errors && !this.props.auth[POST_USER].errors.length){
    ...
    getErrors = () => {
        if (this.props.auth && this.props.auth[POST_USER])
            if (this.props.auth[POST_USER].errors) return this.props.auth[POST_USER].errors
        return []
    }
    render(){
        ...
        return (
            <React.Fragment>
                ...
                />
                <Button value="Go to: Login" href="/login"/>
            </React.Fragment>
        )
    }
}
